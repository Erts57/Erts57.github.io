...
/* harmony default export */ __webpack_exports__["default"] = (async function ({
  ...
  function updateLockDisplay() {
    ...
    if (flyoutLock) lockDisplay.classList.add("locked");else lockDisplay.classList.remove("locked");
  }
  ...
  while (true) {
    ...
    const blocksWrapper = document.querySelector('[class*="gui_blocks-wrapper_"]'); // Placeholder Div
